...
class PWI4:
    ...
    def mount_spiral_offset_new(self, x_step_arcsec, y_step_arcsec):
        ...
        return self.request_with_status("/mount/spiral_offset/new", x_step_arcsec=x_step_arcsec,
    ...
    def mount_model_add_point(self, ra_j2000_hours, dec_j2000_degs):
        ...
        return self.request_with_status("/mount/model/add_point", ra_j2000_hours=ra_j2000_hours,
                                        dec_j2000_degs=dec_j2000_degs)
    ...
    def __init__(self, status_dict):
        ...
        for axis_index in range(2):
            ...
            axis.setpoint_velocity_degs_per_sec = self.get_float(
                prefix + "setpoint_velocity_degs_per_sec")  # Added in 4.0.13
            axis.measured_velocity_degs_per_sec = self.get_float(
                prefix + "measured_velocity_degs_per_sec")  # Added in 4.0.13
            axis.acceleration_degs_per_sec_sqr = self.get_float(
                prefix + "acceleration_degs_per_sec_sqr")  # Added in 4.0.13
